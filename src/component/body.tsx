...
const Body = () => {
    ...
    return(
        <Stack height={'300'} width={1262} direction={'row'} sx={{borderRight:3, borderLeft:3, color:'#8AC1C9', bgcolor:'#B5C2D2'}}>
            <Box  width={1000} height={300}>
                <Typography fontStyle={'Dancing Script'} textAlign={'center'} sx={{ml:-16}} variant="h6" color={'#599585'}>
                    Front End
                </Typography>
                ...
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='Html Logo' src={htmlLogo} width={40} height={45} style={{ cursor: 'pointer' }} onClick={handleClickHtml}></img>
                </Box>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='Css Logo' src={cssLogo} width={47} height={45} style={{ cursor: 'pointer' }} onClick={handleClickCss}></img>
                </Box>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='BootStrap Logo' src={bootStrapLogo} width={80} height={50} style={{ cursor: 'pointer' }} onClick={handleClickBootstrap}></img>
                </Box>
                </Stack>
                <Stack direction={"row"} spacing={1} sx={{mt:1, ml:1}}>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='React Logo' src={reactLogo} width={110} height={65} style={{ cursor: 'pointer' }} onClick={handleClickReact}></img>
                </Box>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='JavaScript Logo' src={javaScriptLogo} width={50} height={40} style={{ cursor: 'pointer' }} onClick={handleClickJs}></img>
                </Box>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='TypeScript Logo' src={typeScriptLogo} width={60} height={45} style={{ cursor: 'pointer' }} onClick={handleClickTs}></img>
                </Box>
                </Stack>
                <Typography fontStyle={'Dancing Script'} textAlign={'center'} sx={{ml:-16}} variant="h6" color={'#599585'}>
                    CI/CD Options
                ...
                <Stack direction={"row"} spacing={1} sx={{mt:1, ml:1}}>
                    ...
                    <img alt='Jenkins Logo' src={jenkinsLogo} width={60} height={45} style={{ cursor: 'pointer' }} onClick={handleClickJenkins}></img>
                    </Box>
                    <Box sx={{ borderRadius: 3,  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='Devops Logo' src={devopsLogo} width={60} height={45} style={{ cursor: 'pointer' }} onClick={handleClickDevops}></img>
                    </Box>
                    <Box sx={{ borderRadius: 3,  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={70} height={70}>
                    <img alt='Gitlab Logo' src={gitlabLogo} width={60} height={45} style={{ cursor: 'pointer' }} onClick={handleClickGitlab}></img>
                    </Box>
                </Stack>
            </Box>
            <Box width={400} height={300}>
            <Typography fontStyle={'Dancing Script'} textAlign={'center'} sx={{ml:1}} variant="h6" color={'#599585'}>
                    cloud
                </Typography>
                ...
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={80} height={80}>
                    <img alt='Aws Logo' src={awsLogo} width={40} height={45} style={{ cursor: 'pointer' }} onClick={handleClickAws}></img>
                </Box>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={80} height={80}>
                    <img alt='Azure Logo' src={azureLogo} width={47} height={45} style={{ cursor: 'pointer' }} onClick={handleClickAzure}></img>
                </Box>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={80} height={80}>
                    <img alt='GoogleCloud Logo' src={glcloudLogo} width={35} height={35} style={{ cursor: 'pointer' }} onClick={handleClickGooglecloud}></img>
                </Box>
                </Stack>
                ...
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={80} height={80}>
                    <img alt='Docker Logo' src={dockerLogo} width={40} height={45} style={{ cursor: 'pointer' }} onClick={handleClickDocker}></img>
                </Box>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={80} height={80}>
                    <img alt='Kubernetes Logo' src={kubernetesLogo} width={67} height={55} style={{ cursor: 'pointer' }} onClick={handleClickKubernetes}></img>
                </Box>
                </Stack>
            </Box>
            <Box width={600} height={300}>
                <Typography fontStyle={'Dancing Script'} textAlign={'center'} sx={{ml:18}} variant="h6" color={'#599585'}>
                    Backend
                </Typography>
                <Stack direction={"row"} spacing={2} sx={{mt:1, ml: 20}}>
                <Box sx={{ borderRadius: '50%',  display: 'flex', justifyContent: 'center', alignItems: 'center'}} bgcolor={'#7A8B93'} width={80} height={80}>
                <Link to="/java-info" >
