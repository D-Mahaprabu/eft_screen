...
const Courses = () => {
    ...
    return (
        <Box className="Courses" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', height: 1120 }}>
            <Typography width={'148px'} height={'35px'} fontFamily={'Poppins'} fontWeight={'400'} fontSize={'32px'} lineHeight={'48px'} color="#D81B0E" sx={{ mt: 5, mr: 150 }}>
                Available
            </Typography>
            <Typography width={'166px'} height={'60px'} fontFamily={'Poppins'} fontWeight={'500'} fontSize={'40px'} lineHeight={'60px'} sx={{ mt: 1, mr: 149  }} style={{ fontWeight: 'bold' }}>
                Courses
            </Typography>
            <Stack 
                sx={{ 
                    ...
                    <Card sx={{ width: 300, height: 380, borderRadius: 2, mr: 1.5 }} key={course.title}>
                      ...
                      />
                        <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'left', justifyContent: 'left' }}>
                            <Typography width={'354px'} height={'34px'} fontFamily={'Poppins'} fontWeight={'bold'} fontSize={'24px'} lineHeight={'33.6px'} letterSpacing={'0.5%'} color={'#D81B0E'} variant="h6" component={Link} to={course.path} sx={{textDecoration: 'none', mt:-1.5}}>
                                {course.title}
                            </Typography>
                            <Typography fontFamily={'Poppins'} color={'#282938'} variant="caption" sx={{mt:-0.2}} fontWeight={'bold'}>
                                {course.info.split('.')[0]}
                            </Typography>
                            <Typography fontFamily={'Poppins'} color={'#282938'} variant="caption" fontWeight={'bold'}>
                                {course.info.split('.')[1]}
                            </Typography>
                        </CardContent>
                    </Card>
