...
const Whychooseus = () => {
    return(
        ...
        <Card sx={{ width: 380, height: 450, mx: 'auto', mt: 13, ml: 16, borderRadius: 2 }}>
        <CardMedia
                component="img"
                width="380"
                height="450"
        ...
        <Card sx={{ width: 380, height: 80, mx: 'auto', mt:3, ml: 16, borderRadius: 2, bgcolor: '#F5F4F0' }}>
          <CardContent>
        ...
        <Typography width={'151px'} height={'12px'} fontStyle={'Poppins'} fontWeight={'600'} fontSize={'17px'} lineHeight={'17px'} letterSpacing={'8&'} sx={{ mt: 13 }} color={'#DA2F26'}>
             Why Choose Us
        </Typography>
        <Typography width={'580px'} height={'60px'} fontStyle={'Manrope'} fontWeight={'700'} fontSize={'48px'} lineHeight={'65.57px'} sx={{ mt: 1 }}>
             Your Learning Journey,
        </Typography>
        <Typography width={'580px'} height={'68px'} fontStyle={'Manrope'} fontWeight={'700'} fontSize={'48px'} lineHeight={'65.57px'} sx={{ ml: 1 }}>
             Your Way
        </Typography>
        <Typography width={'580px'} height={'78px'} fontStyle={'DM Sans'} fontWeight={'400'} fontSize={'16px'} lineHeight={'26px'} sx={{ mt: 1.5 }} color={'#7F8490'}>
        ...
        <Typography width={'254px'} height={'25px'} fontStyle={'Manrope'} fontWeight={'700'} fontSize={'18px'} lineHeight={'24.59px'} sx={{mt: -4.2, ml: 7, mb:3 }}>
        ...
        <Typography width={'300px'} height={'25px'} fontStyle={'Manrope'} fontWeight={'700'} fontSize={'18px'} lineHeight={'24.59px'} sx={{ mt: -4.2, ml: 7, mb:3 }}>
        ...
        <Typography width={'253px'} height={'25px'} fontStyle={'Manrope'} fontWeight={'700'} fontSize={'18px'} lineHeight={'24.59px'} sx={{ mt: -4.2, ml: 7, mb:2 }} color={'black'}>
