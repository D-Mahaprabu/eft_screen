...
const Whychooseus = () => {
    return(
        ...
        <Card sx={{ width: 380, height: 80, mx: 'auto', mt:3, ml: 16, borderRadius: 2, bgcolor: '#F5F4F0' }}>
          <CardContent>
            <Box sx={{ width: '50px', height: '50px', borderRadius: '6px', bgcolor: '#D82C25', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 35 }}>
                ...
                <Typography width={'300px'} height={'52px'} fontFamily={'Poppins'} fontWeight={'400'} fontSize={'16px'} lineHeight={'26px'} sx={{mt: -6.5, ml: 7}}>
        ...
        <Typography width={'580px'} height={'60px'} fontFamily={'Poppins'} fontWeight={'700'} fontSize={'48px'} lineHeight={'65.57px'} sx={{ mt: 1 }}>
        ...
        <Typography width={'254px'} height={'25px'} fontFamily={'Poppins'} fontWeight={'700'} fontSize={'18px'} lineHeight={'24.59px'} sx={{mt: -4.2, ml: 7, mb:3 }}>
        ...
        <Typography width={'253px'} height={'25px'} fontFamily={'Poppins'} fontWeight={'700'} fontSize={'18px'} lineHeight={'24.59px'} sx={{ mt: -4.2, ml: 7, mb:2 }} color={'black'}>
