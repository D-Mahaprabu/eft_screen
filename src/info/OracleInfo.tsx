        ...
        <Stack>
            ...
            <Box height={'auto'} width={'60%'} sx={{ ml: 2 }} >
                <Stack direction={'row'} sx={{mt:3}}>
                    <Box height={'50px'} width={'50px'}><img src={OracleLogo} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain' }}/></Box>
