    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                        Prometheus empowers you to monitor and alert on system metrics efficiently, analyze time-series data for valuable insights, customize metrics for improved system reliability, enhance observability in complex environments, and advance your skills in managing and scaling monitoring solutions.
                    </Typography>
                );
            case 1:
            ...
            <Stack direction={'row'} justifyContent={'space-between'}>
                <Box height={'auto'} width={'60%'} sx={{ ml: 2 }}>
                    ...
                    <Stack width={'auto'} direction={'row'}>
                        ...
                        <Typography sx={{ mt: 2.5, ml: 1 }}>19 Hours</Typography>
                        <Box sx={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 35, height: 35, borderRadius: '50%', bgcolor: '#D82C25', color: 'white', mt: 2, ml: 3, position: 'relative', overflow: 'hidden' }}>
                            <MenuBookIcon />
                        </Box>
