            ...
            case 0:
                return (
                    <Typography variant="body1">
                       EA(Enterprise Architect) is a framework that facilitates an organization’s integration of IT architecture into its business strategy, thus allowing all these components of the business to be integrated in a streamlined and efficient manner. 
                    </Typography>
                );
            case 1:
                return (
        ...
        <Stack>
            ...
            <Box height={'auto'} width={'60%'} sx={{ ml: 2 }} >
                <Stack direction={'row'} sx={{mt:3}}>
                    <Box height={'50px'} width={'50px'}><img src={EnterpriseArchitectureLogo} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain' }}/></Box>
