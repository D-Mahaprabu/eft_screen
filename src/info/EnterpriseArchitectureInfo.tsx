    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                        Enterprise architecture module equips you to design and implement cohesive, scalable systems, align IT strategies with business goals, improve organizational efficiency, manage complex technology landscapes, and enhance your ability to drive strategic IT initiatives.
                    </Typography>
                );
            case 1:
