    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                        <strong>Docker</strong> is a platform that enables developers to automate the deployment of applications inside lightweight, portable containers.<br /><br />
                        <strong>Containers:</strong> encapsulate an application and its dependencies, ensuring consistent behavior across different environments.<br /><br />
                        <strong>Docker Engine:</strong> is the core of Docker, responsible for building, running, and managing containers.<br /><br />
                        <strong>Dockerfile:</strong> is a script containing a series of instructions to build a Docker image.<br /><br />
                        <strong>Images:</strong> are read-only templates used to create containers. They can be shared via Docker Hub or private registries.<br /><br />
                        <strong>Docker Hub:</strong> is a public registry that hosts Docker images, allowing easy sharing and reuse.<br /><br />
                        <strong>Volumes:</strong> are used to persist data generated by Docker containers, ensuring data isn't lost when a container stops.<br /><br />
                        <strong>Networks:</strong> in Docker allow containers to communicate with each other securely.<br /><br />
                        <strong>Docker Compose:</strong> is a tool for defining and running multi-container Docker applications using a docker-compose.yml file.<br /><br />
                        <strong>Swarm:</strong> mode provides native clustering and orchestration for Docker, enabling container management across multiple hosts.<br /><br />
                        <strong>Multi-stage Builds:</strong> Docker supports multi-stage builds, allowing you to optimize image size by separating build dependencies from runtime dependencies.<br /><br />
                        <strong>Portability:</strong> Docker containers can run on any machine with Docker installed, ensuring consistent deployment across environments.<br /><br />
                        <strong>Isolation:</strong> Containers are isolated from each other and the host, enhancing security and resource allocation.<br /><br />
                        <strong>Efficiency:</strong> Containers share the host OS kernel, making them more efficient than traditional VMs.<br /><br />
                        <strong>Version Control:</strong> Docker images are versioned, allowing rollback to previous versions if needed.<br /><br />
                        <strong>Scalability:</strong> Docker simplifies scaling applications up or down by adding or removing containers.<br /><br />
                        <strong>Cross-Platform Compatibility:</strong> Docker supports various operating systems, including Linux, Windows, and macOS, enabling cross-platform development and deployment.<br /><br />
                        <strong>Continuous Integration/Continuous Deployment (CI/CD):</strong> Docker integrates well with CI/CD pipelines, facilitating automated testing and deployment.<br /><br />
                        <strong>Security:</strong> Docker provides features like image scanning and content trust to enhance container security.<br /><br />
                        <strong>Docker CLI & GUI:</strong> Docker provides both a command-line interface (CLI) and graphical user interface (GUI) tools like Docker Desktop, making it accessible for both command-line users and those who prefer a visual interface.
                    </Typography>
                );
            case 1:
