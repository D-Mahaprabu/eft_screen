            ...
            case 0:
                return (
                    <Typography variant="body1">
                       Debugging in Software Engineering is the process of identifying and resolving errors or bugs in a software system.
                       It’s a critical aspect of software development, ensuring quality, performance, and user satisfaction. Despite being time-consuming, effective debugging is essential for reliable and competitive software products.
                    </Typography>
                );
            case 1:
                return (
        ...
        <Stack>
            ...
            <Box height={'auto'} width={'60%'} sx={{ ml: 2 }} >
                <Stack direction={'row'} sx={{mt:3}}>
                    <Box height={'50px'} width={'50px'}><img src={DebuggingSkillsLogo} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain' }}/></Box>
