    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                       Debugging in Software Engineering is the process of identifying and resolving errors or bugs in a software system.<br/>
                       It’s a critical aspect of software development, ensuring quality, performance, and user satisfaction.<br/> 
                       Despite being time-consuming, effective debugging is essential for reliable and competitive software products.
                    </Typography>
                );
            case 1:
