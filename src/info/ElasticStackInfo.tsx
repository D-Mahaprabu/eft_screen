    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                        Elastic Stack course equips you with the skills to efficiently search, analyze, and visualize large volumes of data in real-time, enhances your ability to monitor and troubleshoot applications, improves your data-driven decision-making, and boosts your employability in data-centric roles.
                    </Typography>
                );
            case 1:
