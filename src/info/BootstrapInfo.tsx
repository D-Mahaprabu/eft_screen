            ...
            case 0:
                return (
                    <Typography variant="body1">
                        ...
                        - Including Bootstrap in a project (CDN, local installation)
                        - Overview of Bootstrap&#39;s file structure
        ...
        <Stack>
            ...
            <Box height={'auto'} width={'60%'} sx={{ ml: 2 }} >
                <Stack direction={'row'} sx={{mt:3}}>
                    <Box height={'50px'} width={'50px'}><img src={Bootstraplogo} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain' }}/></Box>
