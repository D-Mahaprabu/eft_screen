    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                        Spring Boot is built on the top of the spring and contains all the features of spring.<br/>
                        Prerequisite for Spring Boot is the basic knowledge Spring framework.<br/>
                        And is becoming favourite of developer’s these days because of it’s a rapid production-ready environment which enables the developers to directly focus on the logic instead of struggling with the configuration and set up.<br/>
