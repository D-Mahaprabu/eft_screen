            ...
            case 0:
                return (
                    <Typography variant="body1">
                       Artificial Intelligence (AI) is rapidly transforming our world. It’s not science fiction anymore; AI is here and impacting everything from how we shop to how doctors diagnose diseases.
                       But what exactly is AI? In a nutshell, Artificial Intelligent (AI) refers to intelligent machines that can mimic human cognitive functions like learning and problem-solving.
                    </Typography>
                );
            case 1:
                return (
        ...
        <Stack>
            ...
            <Box height={'auto'} width={'60%'} sx={{ ml: 2 }} >
                <Stack direction={'row'} sx={{mt:3}}>
                    <Box height={'50px'} width={'50px'}><img src={AiLogo} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain' }}/></Box>
