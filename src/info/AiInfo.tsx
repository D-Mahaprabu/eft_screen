    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                       Artificial Intelligence (AI) is rapidly transforming our world.<br/> 
                       It’s not science fiction anymore; AI is here and impacting everything from how we shop to how doctors diagnose diseases.<br/>
                       But what exactly is AI? In a nutshell, Artificial Intelligence (AI) refers to intelligent machines that can mimic human cognitive functions like learning and problem-solving.
                    </Typography>
                );
            case 1:
