    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                        This course enables you to efficiently manage database interactions through advanced ORM techniques, optimize performance with caching and query strategies, simplify data persistence, improve application scalability, and enhance your overall proficiency in building robust, data-driven Java applications.
                    </Typography>
                );
            case 1:
        ...
        <Stack>
            ...
            <Box height={'auto'} width={'60%'} sx={{ ml: 2 }} >
                ...
                <Stack width={'auto'} direction={'row'}>
                    ...
                    <Typography sx={{ mt: 2.5, ml:1 }}>22 Hours</Typography>
                    <Box sx={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 35, height: 35, borderRadius: '50%', bgcolor: '#D82C25', color: 'white', mt: 2, ml: 3, position: 'relative', overflow: 'hidden' }}>
                        <MenuBookIcon />
                    </Box>
