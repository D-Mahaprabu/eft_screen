    ...
    const renderContent = () => {
        switch (activeTab) {
            case 0:
                return (
                    <Typography variant="body1">
                        Learning Advanced AWS skills allow you to efficiently manage and optimize cloud resources, improve cost-efficiency, and ensure high availability and performance of applications.
                    </Typography>
                );
            case 1:
